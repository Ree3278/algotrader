...
FEATURE_BLOCKS = {
    ...
    "atr_percentile": FeatureBlock("atr_percentile", tuple(ATR_PERCENTILE_FEATURE_COLUMNS)),
...
PROFILE_PRESETS = {
    ...
    "price_plus_regime_plus_trend_state_plus_atr_percentile": ("price_only", "regime", "trend_state", "atr_percentile"),
