...
def run_holdout_pipeline(config: HoldoutPipelineConfig) -> HoldoutRunResult:
    ...
    if len(train_data) >= experiment_config.min_training_size + calibration_size:
        ...
        threshold_selection = select_thresholds(
            ...
            experiment_config.threshold_selection_objective_name,
            experiment_config.calibration_return_weight,
            experiment_config.calibration_exposure_target,
            experiment_config.calibration_exposure_penalty,
            experiment_config.calibration_turnover_penalty,
            experiment_config.calibration_drawdown_target,
            experiment_config.calibration_drawdown_penalty,
        )
